...
def generate_caption(post):
    ...
    lines.append("@MoviesWebSeries_08 | @Movielink_08")
    lines.append("@SKxMOVIES_RequestBot | @New_Movie_Chat")
    lines.append("@SKxMOVIES | @The_Sk08")
    lines.append("")
    lines.append(f'⚖️ <a href="{DMCA_IMAGE_URL}"><b>DMCA & Content Disclaimer</b></a>')
    lines.append("We do not host any files. Takedown → @SKxMOVIES_RequestBot")
    lines.append("")
    lines.append("🔔 Stay Connected • Stay Updated 🚀")
